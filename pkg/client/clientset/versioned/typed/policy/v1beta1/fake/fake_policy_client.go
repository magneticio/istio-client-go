...
import (
	v1beta1 "github.com/magneticio/istio-client-go/pkg/client/clientset/versioned/typed/policy/v1beta1"
...
func (c *FakePolicyV1beta1) Instances(namespace string) v1beta1.InstanceInterface {
