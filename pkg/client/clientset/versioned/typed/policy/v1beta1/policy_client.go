...
// PolicyV1beta1Client is used to interact with features provided by the policy.istio.io group.
type PolicyV1beta1Client struct {
	restClient rest.Interface
}

func (c *PolicyV1beta1Client) Instances(namespace string) InstanceInterface {
