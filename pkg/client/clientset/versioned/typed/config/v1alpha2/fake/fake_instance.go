...
type FakeInstances struct {
	Fake *FakeAuthenticationV1alpha2
	ns   string
}

var instancesResource = schema.GroupVersionResource{Group: "authentication.istio.io", Version: "v1alpha2", Resource: "instances"}

var instancesKind = schema.GroupVersionKind{Group: "authentication.istio.io", Version: "v1alpha2", Kind: "Instance"}
